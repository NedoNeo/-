...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let routeContainer = document.querySelector(".route__container");
  routeContainer.addEventListener("click", (event) => {
    if (event.target.closest(".route__list-item")) {
        event.target.closest(".route__list-item").querySelector(".christ").click();
    }
  })

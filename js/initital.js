...
const lastYearSlider = document.querySelector(".last_year-slider")
...
lastYearSlider.addEventListener("click", (event) => {
    if(event.target.closest(".last_year-link")) {
        let link = event.target.src
        console.log(document.getElementById("full_image").getElementsByTagName("img"))
        document.getElementById("full_image").getElementsByTagName("img")[0].setAttribute("src", link);
    }
})
